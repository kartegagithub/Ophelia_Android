...
public class EARequestBuilder {
    ...
    public EARequestBuilder addJsonBody(String key, String value) {
    ...
    public EARequestBuilder setJsonBody(JSONObject jsonBody) {
        if(jsonBody != null){
                ...
                if (!fieldName.equals("serialVersionUID") && !fieldName.equals("$change"))
                    try {
                        ...
                        if (type.contains("int")) {
                            ...
                            if(result != null && !StringUtils.isEmptyString(result.toString()))
                                isEmpty = false;
                        } else if (result != null)
                            isEmpty = false;
